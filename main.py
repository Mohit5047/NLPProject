...
input_text2 = list()
input_text2.append("Jack bombed John near Mumbai on Monday")
# input_text2.append("The Armed Forces Press Committee reported that an AK-47 was seized by the Military from Ernesto")
# input_text2.append("Brazilian Police agents seized a lab in Western Mato Grosso")
# input_text2.append("National Police in Bogota seized 3 cocaine processing laboratories as it was reported on 17 May")
# input_text2.append("Police in Mumbai seized six tons of marijuana at a plantation in Pune")
# input_text2.append("Federal Police seized 781 kg of pure cocaine in a trailed from Guatemala to Houston")
# input_text2.append("The Narcotics Police arrested 8 drug traffickers for drug smuggling charges")
#input_text2.append("NFL players have been arrested 855 times since 2000")
#input_text2.append("Charlie Rogers, a former NFL player and local football star, was arrested by the Aberdeen Police Department on Monday")
for text_file in input_text2:
    input_text = text_file
    print(input_text)
    print()
#input_text = "Alleged guerrilla urban commandos launched two high-power bombs against a car dealership in Downtown San Salvador this Morning."
